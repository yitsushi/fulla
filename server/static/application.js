...
var $author$project$Page$SignIn$Update$sendLoginForm = F2(
	function (model, msg) {
		return $elm$http$Http$post(
			{
				body: $elm$http$Http$jsonBody(
					$author$project$Page$SignIn$Update$loginEncoder(model)),
				expect: A2($elm$http$Http$expectJson, msg, $author$project$Page$SignIn$Update$loginDecoder),
				url: '/api/login'
			});
	});
var $author$project$App$Message$SignIn = function (a) {
	return {$: 'SignIn', a: a};
};
var $author$project$Page$SignIn$Update$wrapMsg = F2(
	function (msg, param) {
		return $author$project$App$Message$SignIn(
			msg(param));
	});
var $author$project$Page$SignIn$Update$update = F3(
	function (msg, global, model) {
		if (msg.$ === 'SignIn') {
			switch (msg.a.$) {
				case 'NameInput':
				...
				case 'SubmitForm':
					...
					return _Utils_Tuple3(
						...
						A2(
							...
							model,
							$author$project$Page$SignIn$Update$wrapMsg($author$project$Page$SignIn$Message$LoginResponse)));
				default:
					var response = msg.a.a;
					if ((response.$ === 'Ok') && (response.a.b === '')) {
						...
						return _Utils_Tuple3(
							...
							$elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										$author$project$App$Port$saveToken(token),
...
var $author$project$Global$View$view = F2(
	function (page, _v0) {
		return _List_fromArray(
			[
				A2(
								...
								[
									...
									_List_fromArray(
										[
											...
											$elm$html$Html$Attributes$class('go-to-gallery')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('Go to Gallery')
										]))
								]);
						case 'NotFound':
							return _List_fromArray(
...
var $author$project$Page$SignIn$Message$SubmitForm = {$: 'SubmitForm'};
	...
	function (_v0, model) {
		return _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('signin-box')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$placeholder('What\'s your name?'),
								$elm$html$Html$Attributes$value(model.signIn.name),
								$elm$html$Html$Events$onInput(
								$author$project$Page$SignIn$View$onInputHandler($author$project$Page$SignIn$Message$NameInput))
							]),
						_List_Nil),
						A2(
						$elm$html$Html$input,
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$placeholder('SignIn with your secret token'),
								$elm$html$Html$Attributes$value(model.signIn.token),
								$elm$html$Html$Events$onInput(
								$author$project$Page$SignIn$View$onInputHandler($author$project$Page$SignIn$Message$TokenInput))
							]),
						_List_Nil),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								...
								$author$project$App$Message$SignIn($author$project$Page$SignIn$Message$SubmitForm))
							]),
						_List_fromArray(
							[
				...
				model.signIn.error ? A2(
				$elm$html$Html$img,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$src('/static/nope.png'),
						$elm$html$Html$Attributes$class('nope')
					]),
...
var $author$project$App$Main$main = $elm$browser$Browser$application(
	{
		init: $author$project$App$Init$init,
		onUrlChange: $author$project$App$Router$onUrlChange,
		onUrlRequest: $author$project$App$Router$onUrlRequest,
...
var $author$project$Main$main = $author$project$App$Main$main;
